...
GameOverState::GameOverState(GameEngine *engine) : GameState(engine)
{
...
void GameOverState::display(unsigned int width, unsigned int height)
{
	glEnable(GL_BLEND);
...
void GameOverState::lButtonUp(POINT pos)
{
