...
void GLShader::init() throw (ShaderException)
{
...
void GLShader::loadSource(const char *filename) throw (ShaderException)
{
...
void GLShader::loadShader() throw (ShaderException)
{
